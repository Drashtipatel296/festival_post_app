...
import 'package:festival_post_app/view/screens/editingscreen/component/background_choose.dart';
import 'package:festival_post_app/view/screens/editingscreen/component/canvas.dart';
import 'package:festival_post_app/view/screens/editingscreen/component/text.dart';
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  image: DecorationImage(
                    ...
                    image: (isImage)
                        ? AssetImage(
                            festivalList[postImageIndex]['images']
                                [backgroundIndex],
                          )
                        : AssetImage(''),
                  ),
          ...
          SingleChildScrollView(
            ...
            child: Row(
              children: List.generate(
                festivalList[postImageIndex]['images']?.length ?? 0,
                (index) => InkWell(
                  onTap: () {
                    setState(() {
                  ...
                  child: Padding(
                    ...
                    child: Container(
                      ...
                      child: Image.asset(
                        festivalList[postImageIndex]['images'][index],
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
